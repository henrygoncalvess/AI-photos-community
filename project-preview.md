...
## Página para se registrar (mostrando erros da validação)

![sign-up](project-images/sign-up.png)

## Página de Login, sem estar registrado

![login sem registro](project-images/entrar-sem-se-registrar.png)

## Mensagens de e-mail enviado
...
## Página de login após e-mail confirmado (com erro de validação)
